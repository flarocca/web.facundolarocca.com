...
export default class ThemeSelectorLeft extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="Container row-reverse fixed main" style={{ left: "0px", top: "40%" }}>
        <input type="checkbox" id="themeLeft" />
        <label id="themeLabelLeft" htmlFor="themeLeft" style={{ background: "rgb(200, 200, 200)" }}>
